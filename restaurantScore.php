  ...
  <div class="mainWrapper">
    ...
    <section id="RestaurantScoreSection">
      ...
      <div class="sliderContainer">
        ...
        <input id="slider-1" type="range" min="0" max="10" step="1" value="5" disabled="disabled">
      ...
      <div class="sliderContainer">
        ...
        <input id="slider-2" type="range" min="0" max="10" step="1" value="5" disabled="disabled">
        <p class="sliderText neutraalT">Neutraal</p>
        <p class="sliderText goedT">Goed</p>
        <p class="sliderText uitstekendT">Uitstekend</p>
      </div>
      ...
      <div class="sliderContainer">
        ...
        <input id="slider-3" type="range" min="0" max="10" step="1" value="5" disabled="disabled">
        <p class="sliderText neutraalT">Neutraal</p>
        <p class="sliderText goedT">Goed</p>
        <p class="sliderText uitstekendT">Uitstekend</p>
      </div>
      ...
      <div class="sliderContainer">
        ...
        <input id="slider-4" type="range" min="0" max="10" step="1" value="5" disabled="disabled">
        <p class="sliderText neutraalT">Neutraal</p>
        <p class="sliderText goedT">Goed</p>
        <p class="sliderText uitstekendT">Uitstekend</p>
      </div>
      ...
      <div class="sliderContainer" id="lastslidercontainer">
        ...
        <input id="slider-5" type="range" min="0" max="10" step="1" value="5" disabled="disabled">
        <p class="sliderText neutraalT">Neutraal</p>
        <p class="sliderText goedT">Goed</p>
        <p class="sliderText uitstekendT">Uitstekend</p>
      </div>
      ...
      <script>
        function disable(){
          ...
          if (document.getElementById('checkbox-2').checked == false) {
            ...
            document.getElementById('slider-2').value = "5";
            } else {
          ...
          if (document.getElementById('checkbox-3').checked == false) {
            ...
            document.getElementById('slider-3').value = "5";
            } else {
          ...
          if (document.getElementById('checkbox-4').checked == false) {
            ...
            document.getElementById('slider-4').value = "5";
            } else {
          ...
          if (document.getElementById('checkbox-5').checked == false) {
            ...
            document.getElementById('slider-5').value = "5";
            } else {
